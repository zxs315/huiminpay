...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
		...
		// 商户服务
		dataSourceConfig
				.setUrl("jdbc:mysql://localhost:3306/huiminpay_merchant_service?serverTimezone=Asia/Shanghai");

		// 交易服务
//		dataSourceConfig
//				.setUrl("jdbc:mysql://localhost:3306/huiminpay_merchant_service?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai");
